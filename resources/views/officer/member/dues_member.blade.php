        ...
        <thead class="table">
         ...
         <tbody>
            ...
            <td>
                ...
                <a href="{{ route('officer.dues_memberEdit', Crypt::encrypt( $item->id )) }}" class="btn btn-sm btn-info"> <i class="fas fa-pen"></i>
                    Edit</a>
                <a href="{{ route('officer.dues_memberDelete', Crypt::encrypt( $item->id )) }}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin data dues member {{ $item->user->nama }} ini dihapus?')">
