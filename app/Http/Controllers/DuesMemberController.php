...
class DuesMemberController extends Controller
{
    public function view()
    {
        ...
        if (Auth::user()->level == 'admin') {
            ...
            return view('officer.member.dues_member', $data);
        }
    }
    ...
    public function create()
    {
       ...
       if (Auth::user()->level == 'admin') {
            ...
            return view("officer.member.tambah_duesMember", $data);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::user()->level == 'admin') {
            ...
            return redirect()->route('officer.dues_member')->with('success', 'Berhasil menambah data Member');
        }
    }
    ...
    public function edit(String $id){
        ...
        if (Auth::user()->level == 'admin') {
            ...
            return view('officer.member.edit_duesMember', $data);
        }
    }
    ...
    public function update(Request $request, String $id){
        ...
        if (Auth::user()->level == 'admin') {
            ...
            return redirect(route('officer.dues_member'))->with('success', 'Data berhasil diubah');
        }
    }
    ...
    public function delete(String $id)
    {
        ...
        if (Auth::user()->level == 'admin') {
            ...
            return redirect(route('officer.dues_member'))->with('success', 'Data berhasil dihapus');
        }
    }
}
